...
var xmlData = XMLData("Estrutura Administrativa_arquivos/data.xml");
...
{
	var strCPHTML = "";
	var strStartTable = "<table class='propViewerTABLE' borderColor='#999999' cellPadding='2' width='95%' border='1' summary='Esta tabela contém detalhes da forma'>";
		strStartTable += "<THEAD class='propViewerTHEAD'><TH>Rótulo</TH><TH>Valor</TH></THEAD>";
	...
	if (shapeNode != null)
	{
		...
		{
			strCPHTML = "Detalhes Não Disponíveis.";
		}
	}
