...
var strShapeName	= "Nome da Forma";
var strShapeText	= "Texto da forma";
var strProps		= "Dados da Forma";
var strResults		= "Resultados da pesquisa para:";

var strShape	= "Nome da Forma:";
var strNoCustomPropertiesToDisplayText = "Pressione CTRL e clique em uma forma no desenho para exibir detalhes.";
...
function FindOnClick()
{
	...
	if (searchTokensArray.length > 0)
	{
		...
		var strResultsHTML = "Nenhuma correspondência encontrada.";
		var lastPageID = null;
		var shapeID;
		...
		if(ArrayLength > 0)
		{
			...
			for ( count = 0; count < ArrayLength; count++)
			{
				...
				strResultsHTML += '<p class="results"><a href="javascript:populateSearchResultDetails(\'results_'+ lastPageID +'_'+ shapeID +'\', '+ lastPageID +','+ shapeID +'); TogglePlus(\'results_' + lastPageID + '_' + shapeID + '\',\'img_' + lastPageID + '_' + shapeID + '\', hideResults)"><img src="plus.gif" style="padding-left:13px" alt="Mostra/oculta detalhes da forma" width="13" height="9" border="0" id="img_'+ lastPageID +'_'+ shapeID +'"></a>\n'
